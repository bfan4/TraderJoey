	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav">
				<a class="nav-item nav-link" href="index.jsp">Home <span
					class="sr-only">(current)</span></a> <a
					class="nav-item nav-link active" href="buy.jsp">Buy/Sell</a> <a
				...
				<div class="card-header">
					<ul class="nav nav-tabs card-header-tabs">
						<li class="nav-item" style="width: 274px;"><a
							class="nav-link active" style="text-align: center;" href="#"><font><b>Buy</b></font></a></li>
						<li class="nav-item" style="width: 274px;"><a
							class="nav-link" href="sell.jsp" style="text-align: center;"><font><b>Sell</b></font></a></li>
					</ul>
				</div>
				<div class="card-body">
